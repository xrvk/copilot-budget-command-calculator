    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <footer className="w-full border-t border-border bg-muted/30 py-3">
        <p className="text-center text-xs text-muted-foreground px-4">
          This resource is provided "as is" for planning purposes only. It is not part of GitHub's official documentation and does not constitute financial or billing advice.
          Budget recommendations are based on data you provide and are your responsibility to review before applying.
          For GitHub's official documentation, pricing, and offerings, please visit{' '}
          <a href="https://docs.github.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground transition-colors">GitHub Docs</a>.
        </p>
      </footer>
