...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <footer className="w-full border-t border-border bg-muted/30 mt-auto py-4">
        <div className="mx-auto max-w-5xl px-4 space-y-2">
          ...
          <p className="text-center text-xs text-muted-foreground">
            ...
            {' · '}
            <a
              href="https://github.com/xrvk/copilot-budget-command-calculator/blob/main/CHANGELOG.md"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary hover:underline underline-offset-2 transition-colors"
            >
