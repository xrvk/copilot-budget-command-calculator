      ...
      <div className="flex-1 space-y-3">
          ...
          <div className="flex items-center justify-end gap-2 min-w-[18rem]">
            ...
            <FormulaTooltip
              ...
              steps={[
                ...
                {
                  label: 'Applied to post-pool additional spend, rounded up',
        ...
        <p className="text-xs text-muted-foreground">
          {powerCc
            ...
            : `Caps the ${powerUsers} power users' share of post-pool charges. Assign them to a cost center first. Stays at $0 while the pool has capacity`
          }
        </p>
                ...
                <AlertDescription className="text-xs space-y-1">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    {effectiveExcludeCostCenterUsage
                      ? `With cost center exclusion on, this is the only budget covering these ${powerUsers} users' post-pool charges`
