      ...
      <div className="flex-1 space-y-3">
        ...
        {credentials ? (
          <div className="space-y-3 pt-1">
              <div className="space-y-3 rounded-lg border border-border p-3 bg-muted/30">
                ...
                {liveUserBudgets.length === 0 && (
                  <p className="text-[11px] text-muted-foreground">No individual user budgets found</p>
                )}
          ...
          <p className="text-xs text-muted-foreground/70 italic">
            <button onClick={onNavigateToImport} className="underline underline-offset-2 hover:text-foreground transition-colors">Connect your Enterprise</button> to manage individual user budgets here.
          </p>
        )}
          </>
        )}
