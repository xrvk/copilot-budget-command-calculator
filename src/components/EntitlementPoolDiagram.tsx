    ...
    <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Tooltip>
            ...
            <TooltipContent sideOffset={8} side="bottom" align="end" className="pointer-events-none max-w-64 text-xs">
              <p className="font-semibold mb-1">Individual user-level budget (priority)</p>
      ...
      <div className={`rounded-xl border-2 p-4 space-y-4 transition-colors ${
        ...
        <Tooltip>
          ...
          <TooltipContent sideOffset={8} side="bottom" align="start" className="pointer-events-none max-w-72 text-xs">
            <p className="font-semibold mb-1">Max metered AIC spend</p>
            <p>The maximum metered charge across all users: the gap between max possible draw and what the pool covers. Setting budgets at or above this ensures users are not blocked</p>
          </TooltipContent>
        </Tooltip>
      </div>
    </div>
